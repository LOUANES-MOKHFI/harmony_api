...
Route::post('get_campaigns_status', [ActionAgentController::class, 'getCampaignStatus'])->name('get_campaigns_status');
...
Route::post('get_call_date', [StatController::class, 'getCallDate'])->name('get_call_date');
