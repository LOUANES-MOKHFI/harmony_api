...
class LoginController extends Controller
{
    ...
    public function customLogin(Request $request){
        ...
        if(!empty($user)){
            ...
            $response = $http->post('https://call3.harmoniecrm.com/agc/vicidial.php', [
                'form_params' => [
                    'VD_login' => $username,
                    'VD_pass' => $pass,
            ...
            //$responseWebPhone = $http->post('https://call3.harmoniecrm.com/agc/api.php?source=test&user=66666&pass=0551797kamel2022&agent_user='.$username.'&function=webphone_url&value=DISPLAY');
            ...
            if($response->getStatusCode() == 200){
                ...
                /*$response2 = $http->post('https://call3.harmoniecrm.com/agc/manager_send.php', [
                    'form_params' => [
                ...
                */
                ...
                $http = new \GuzzleHttp\Client();
                $responseWebPhone = $http->post('https://call3.harmoniecrm.com/agc/api.php?source=test&user=66666&pass=0551797kamel2022&agent_user='.$data['user'].'&function=call_agent&value=CALL');
