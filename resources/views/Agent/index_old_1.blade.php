            ...
            <div class="col-md-12 dashboard_panel ">
                    ...
                    <div class="portlet light profile-sidebar-portlet bordered">
                        ...
                        <div class="profile-userbuttons">
                            <button type="button" data-value="PAUSED"
                                    class="btn btn-circle green-haze btn-sm  agentStatusButton">Démarrer la production</button>
                ...
                <div class="col-md-12 bloc_attente" style="display:none;">
                    <div class="col-md-6 coming-soon-content">
                        ...
                        <br> <button 
                                class="btn btn-default btn-outlined btn-square back-to-menu agentStatusButton">      </a>
                    </div>
                    <div class="col-md-6 ">
                        <div id="tempattente">
                    ...
                    <!--div class="row" id="loadQueueDiv" style="display:none">
                        <div class="col-md-12">
                            <div class="portlet box">
                                <div class="portlet-body" style="background: url({{asset('assets/agents/vvci/assets/metronic/assets/pages/img/bg-white.png')}}) repeat;">
                                    <table class="table table-striped table-hover thumb-small table-condensed">
                                        <thead>
                                        <tr class="condensed" style="background: url({{asset('assets/agents/vvci/assets/metronic/assets/pages/img/bg-white.png')}}) repeat;">
                                            <th scope="col">Numéro<span class="column-sorter"></span></th>
                                            <th scope="col">Nom<span class="column-sorter"></span></th>
                                            <th scope="col">Temps d'attente<span class="column-sorter"></span></th>
                                            <th scope="col">Fichier<span class="column-sorter"></span></th>
                                            <th scope="col">Etat<span class="column-sorter"></span></th>
                                            <th scope="col">Décrocher<span class="column-sorter"></span></th>
                                        </tr>
                                        </thead>
                                        <tbody class="media-thumb" id="queues-table">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 text-right">
                            <button type="button" class="btn yellow ignore_inbound_calls">Ignorer les appels entrants</button>
                        </div>
                    </div-->
                </div>
        ...
        <div class="row">
            <div clas="col-md-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>First :</label>
                        <input name="contact_nom" type="text" class="form-control contact_nom" id="contact_nom" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Last :</label>
                        <input name="contact_prenom" type="text" class="form-control contact_prenom" id="contact_prenom" />
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>contact_ville :</label>
                        <input name="contact_ville" type="text" class="form-control" id="contact_ville" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
...
<script>
    ...
    /* jshint expr: true */
        var centi = 0; var mili = 0; var sec = 0; var min = 0; var heur = 0;
        var sec_; var min_; var heu_; 
        var afficher; var compteur;
        // affichage du compteur à 0
        document.getElementById('time').innerHTML ="0" + heur + ":" + "0" + min + ":" + "0" + sec;
        function chrono() {
            ...
            afficher = heur_ + ":" + min_ + ":" + sec_ ;
            document.getElementById("time").innerHTML = afficher;
            
            reglage = setTimeout("chrono();",100);
        } 
        ...
        function raz() //====pour remettre à zéro
            { 
                    ...
                    afficher = heur + "0:" + min + "0:" + sec + "0:" + centi + mili;
                    document.getElementById("time").innerHTML = afficher;
...
<script>
    ...
    $(document).ready(function(){
        const GetNewChannel = setInterval(function(){  
            var etat = $("#etat_agent").val();
            if(etat == 'READY'){
                chan = document.getElementById('channel').value;
                if(chan == null || chan == ''){
    ...
    $(document).ready(function(){
        const ChangeToCall = setInterval(function(){
            chan = document.getElementById('channel').value;
                                ...
                                {   
                                    ...
                                    if(abrv == "DM" && listStatuslength >2){
                                        ...
                                        $('#autre').append(`
                                            <option value="${element.status}"> ${element.status_name}</option>
                                        `);
                                        /*if(abrv == "RP" || abrv == "REL" || abrv == "REP" abrv == "WFT" abrv == "IND" || abrv == "INDOLD" || abrv == "DOUBL"){
                                        $('#autre').append(`
                                            <option value="${element.status}"> ${element.status_name}</option>
                                        `); */
                                    }
